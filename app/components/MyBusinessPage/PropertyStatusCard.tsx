...
const PropertiesStatusCard = ({ data }: PropertiesStatusCardProps) => {
  const statusFeild = {
      ...
      {data?.stage == "live" ? (
        <View className="flex-1 bg-[#D2D2D2] py-[10px] px-[12px]">
          <View className="flex flex-row items-center justify-between   h-[42px]">
            ...
            <Text className="font-bold text-base leading-normal">
        ...
        <View className="flex-1 bg-[#D2D2D2] py-[10px] px-[12px]">
          <View className="flex flex-col items-start justify-between   h-[42px]">
            <Text className="font-bold text-base leading-normal">Status</Text>
            <View className="flex flex-row items-center justify-between gap-[5px]">
              <Text className="font-bold text-base leading-normal">
                {toCapitalizedWords(data?.status)}
              </Text>
